...
const SECTION_META: Record<Section, { title: string; description: string }> = {
  ...
  import: {
    ...
    description: "Upload or paste a resume and review what XpertApply extracted before saving."
  },
  personal: {
  ...
  preferences: {
    ...
    description: "The roles, levels, and locations XpertApply should match you against."
  },
