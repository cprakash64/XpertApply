 ...
 *
 * The published Chrome Web Store listing when production configuration supplies
 * one (NEXT_PUBLIC_CHROME_EXTENSION_URL), otherwise the in-repo build-and-load
 * instructions — which is exactly what a local or self-hosted install needs, and
 * is a live page either way. No guessed store ID ever appears here.
 */
const EXTENSION_DOCS_URL =
  "https://github.com/cprakash64/JobPilot-AI/tree/main/apps/extension#readme";
const EXTENSION_INSTALL_URL = chromeExtensionUrl() ?? EXTENSION_DOCS_URL;
