...
- **TikTok** (`lifeattiktok.com`): the adapter activated and inventoried both legal identities
  ...
  action.
- **ServiceNow / SmartRecruiters**: `ATS populated 0 · XpertApply filled 9 · section records added 0`,
...
A second authenticated ServiceNow run: XpertApply types the stored Title/Company/Institution, the
