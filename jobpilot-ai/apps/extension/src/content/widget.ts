    ...
    <section class="box" aria-live="polite">
      ...
      <div class="body">
        ...
        <div class="actions">
          ...
          <button type="button" data-a="reconnect" style="display:none">Reconnect to JobPilot</button>
          ...
          <details class="more-actions">
            ...
            <div class="more-grid">
              <button type="button" data-a="clear">Clear JobPilot-filled fields</button>
              <button type="button" data-a="teach" aria-pressed="false" title="Watch how you answer, and offer to remember it">Teach JobPilot</button>
    ...
    for (const action of item.actions) {
      ...
      if (action === "apply_approved_answer") {
        button.addEventListener("click", async () => {
          ...
          say("TikTok kept the approved selection and JobPilot verified it.");
        });
        continue;
      }
      ...
      if (action === "leave_unresolved") {
        button.addEventListener("click", async () => {
          ...
          setBusy(false);
          if (!outcome.ok) {
            say("JobPilot could not record that. Nothing was changed.", true);
            return;
          }
          openChoiceFor = null;
      ...
      button.addEventListener("click", () => {
        ...
        choiceBlock = renderChoiceBlock(item, {
          onChoose: async (value) => {
            ...
            if (sessionId == null) {
              say("JobPilot is not connected to this application right now.", true);
              return;
            }
  ...
  return {
    update(value) {
      ...
      const sourceParts = [
        ...
        value.jobpilotFilled == null ? "" : `JobPilot filled ${value.jobpilotFilled}`,
      ...
      reconnectBtn.textContent = value.reconnecting ? "Reconnecting…" : "Reconnect to JobPilot";
